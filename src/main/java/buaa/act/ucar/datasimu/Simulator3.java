...
public class Simulator3 {
	...
	public static void main(String[] args) {
		args = new String[] { "2016-06-01 12:00:00", "2018-01-15 10:00:00", "3600", "100000", "1", "test-1" };
		if (args != null && args.length == 6) {
			...
			System.out.println(
					"Usage: <dateSource> <dateTarget> <intervalSeconds> <carsimuNumber> <methodNumber> <jobId>");
			System.out.println(
